...
static_error_tests! {
    ...
    {
        name: duplicate_fun_fail1,
        file: "duplicate_fun_fail1.snek",
        expected: "Invalid",
    },
    {
        name: duplicate_fun_fail2,
        file: "duplicate_fun_fail2.snek",
        expected: "Invalid",
    },
    {
        name: undef_fun_fail1,
        file: "undef_fun_fail1.snek",
        expected: "Invalid",
    },
    {
        name: undef_fun_fail2,
        file: "undef_fun_fail2.snek",
        expected: "Invalid",
    },
    {
        name: invalid_fun_name,
        file: "invalid_fun_name.snek",
        expected: "Invalid",
    },
    {
        name: invalid_fun_arg,
        file: "invalid_fun_arg.snek",
        expected: "Invalid",
    },
    {
        name: invalid_input_fun,
        file: "invalid_input_fun.snek",
        expected: "Invalid",
    },
    {
        name: invalid_fun_args,
        file: "invalid_fun_args.snek",
        expected: "Invalid",
    },
